...
import com.whodundid.artifactRun.game.component.tile.components.DamageComponent;
...
import com.whodundid.artifactRun.game.component.tile.components.TileTypeComponent.WorldTileType;
import com.whodundid.artifactRun.game.component.tile.components.VisionModifierComponent;
import com.whodundid.artifactRun.game.component.tile.components.WorldTileRendererComponent;
import com.whodundid.artifactRun.game.component.tile.components.WorldTileRendererComponent.TileAnimationMode;
...
public class WorldTileTest {
    ...
    void testTileIdIsGenerated() {
        ...
        assertNotNull(tile.getObjectId());
    }
    ...
    void testHasComponentByClassAndName() {
        ...
        assertTrue(tile.hasComponent(WorldTileComponentType.TILE_TYPE));
    }
