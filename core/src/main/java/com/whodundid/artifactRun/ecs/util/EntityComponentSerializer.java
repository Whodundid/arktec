...
public class EntityComponentSerializer implements JsonSerializer<EntityComponent> {
    
    @Override
    public JsonElement serialize(EntityComponent src, Type typeOfSrc, JsonSerializationContext context) {
